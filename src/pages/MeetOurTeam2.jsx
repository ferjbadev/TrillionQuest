...
const MeetOurTeam = () => {
    return (
        <div
            className="w-full h-[100vh] flex flex-col md:block items-center justify-center md:justify-around  bg-no-repeat bg-bottom"
            style={{ backgroundImage: `url(${RayOfLight})` }}
        >
            {/* Titulo */}
            <span className="capitalize text-2xl md:text-5xl font-extrabold text-white">
                meet our team
            </span>
